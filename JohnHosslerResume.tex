...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
  ...
  \begin{itemize}
    ...
    \item {\bf Utilities:} Kubernetes, ansible, puppet, juju, Bash, git, vim, \LaTeX, Docker, Pytest, PyPi, Artifactory, Jenkins, Robot Framework
    \item {\bf Operating Systems:} Arch Linux, Ubuntu, Windows
  \end{itemize}
