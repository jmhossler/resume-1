...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
  ...
  \begin{itemize}
    ...
    \item {\bf Methodologies:} Agile, Clean Code, Pair Programming
    \item {\bf Utilities:} Netconf, RestConf, bash, git, vim, \LaTeX, Docker, Pytest, Tox, PyPi, Artifactory, Jenkins, Robot Framework
