...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
  ...
  \begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
    ...
    \texttt{jmhossler.github.com} & \texttt{github.com/jmhossler}
  ...
  \begin{itemize}
    \item {\bf Languages:} Go, Python, C, C++, Javascript, Bash
    \item {\bf Methodologies:} Agile, Clean Code, Pair Programming, SAFe
    \item {\bf Utilities:} Netconf, RestConf, bash, git, vim, \LaTeX, Docker, Pytest, Tox, PyPi, Artifactory, Jenkins, Robot Framework, Jira, Confluence
    \item {\bf Operating Systems:} Linux (several distributions), Mac OS X, Windows
  \end{itemize}
