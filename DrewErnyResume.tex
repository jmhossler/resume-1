...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
  ...
  \begin{itemize}
    ...
    \item {\bf Web:} HTML5/CSS3/Javascript (standard front end stack), Ruby on Rails or PHP back end. Sass and Haml.

    \item {\bf Software and Technology:} Strong understanding of Unix (including server administration), bash, zsh, git, vim, and tmux. Some experience with AWS S3 and Cloudfront.
  ...
  \begin{itemize}
    ...
    \item
      ...
      \begin{itemize}
          \resitem{Totally custom size built with Middleman and hosted on Github Pages.}
          \resitem{Extensive use of latest web concepts such as semantic HTML5 and CSS3 Flexboxes.}
  ...
  \begin{itemize}
    ...
    \item
      \ressubheading{Vice Chair}{Association for Computing Machinery, University of Alabama Student Chapter}{}{January 2013 - September 2013}
      \begin{itemize}
