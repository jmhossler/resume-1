...
\newcommand{\resitem}[1]{\item #1 \vspace{-2pt}}
  ...
  \begin{itemize}
    \item {\bf Languages:} Ruby, Python, Javascript, C, Java, PHP
    ...
    \item {\bf Other technologies:} AWS, Docker, Deep Freeze, Symantech Ghost, LDAP, Kerberos
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item
      \ressubheading{The Nine (nine.is)}{Tuscaloosa, AL}{Software Engineer}{November 2013 - August 2014}
      \begin{itemize}
    ...
    \item
      \ressubheading{Technology Assistant, eTech}{Tuscaloosa, AL}
      {Student Technology Assistant}{January 2013 - April 2013}
      \begin{itemize}
          \resitem{Performed on and off site troubleshooting, repair, setup, and installation ofhardware and software for the University of Alabama College of Arts \& Sciences.}
      \end{itemize}
  \end{itemize}
